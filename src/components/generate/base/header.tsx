  ...
  return (
    <View className="mb-4 flex-row items-center justify-between">
      <View className="flex-row items-center gap-3">
        ...
        <Text className="font-montserrat-bold text-xl text-black dark:text-white">10</Text>
      </View>
      <Text className="font-montserrat-bold text-2xl text-black dark:text-white">Visua</Text>
